...
export const STORAGE_AUTH_USER_KEY = 'pythia.auth.user';
export const STORAGE_AUTH_TOKEN_KEY = 'pythia.auth.token';
...
export class AuthService {
  ...
  public isAuthenticated(verifiedOnly: boolean): boolean {
    ...
    const result: LoginResult | null =
      this._localStorage.retrieve<LoginResult | null>(
   ...
   * @returns 2 for admin, 1 for registered; else 0.
   */
